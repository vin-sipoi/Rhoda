...
export interface ApiRhodaRhoda extends Struct.CollectionTypeSchema {
  collectionName: 'rhodas';
  info: {
    displayName: 'Learner';
    pluralName: 'rhodas';
    singularName: 'rhoda';
  ...
  attributes: {
    ...
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    Enrolled_course: Schema.Attribute.Text &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
        };
    ...
    locale: Schema.Attribute.String;
    localizations: Schema.Attribute.Relation<'oneToMany', 'api::rhoda.rhoda'>;
    Name: Schema.Attribute.String &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
